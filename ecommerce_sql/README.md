...
Всі замовлення мають ненульову знижку, тому аналіз робиться між рівнями знижок, а не «зі знижкою vs без»;
Невеликий обсяг даних (600 рядків), тому висновки ілюстративні, а не статистично надійні.
